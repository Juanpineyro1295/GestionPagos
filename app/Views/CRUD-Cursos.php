      ...
      <div class="text-light mt-5 mb-5" style="width:95%; margin:auto;">
        <div class="card bg-dark">
          ...
          <div class="card-body table-responsive-xxl align-right">
            ...
            <?php } ?>
            <div class="d-flex">
              <a type="button" style="margin-left: auto;" class="btn btn-light text-dark mb-3" href="<?= base_url('crear-curso');?>">Agregar Curso</a>
            </div>
            <table id="users-list" class="sortable table table-dark table-bordered table-hover border border-1 mt-5">
              ...
              <thead class="table-light">
                <tr>
                  ...
                  <th class="no-sort align-top user-select-none" style="width: 162px; text-align: center;  padding-right: 10px; padding-left: 10px;">Modificar</th>
                </tr>
              </thead>
              <tbody>
    <?php 
    $cursos = $curso_model->findAll();
    if (count($cursos) > 0) { 
            foreach($cursos as $curso) { ?>
                <tr>
                  <td class="num text-center"><?= $curso["curso_descripcion"]?></td>
                  <?php $idioma = $idioma_model->where('id_idioma', $curso["id_idioma"])->first();?>
                  <td class="text-center"><?= $idioma["idioma_descripcion"]?></td>
                  <td class="text-center"><?= $curso["curso_precio"]?></td>
                </tr>
      <?php } ?>
              </tbody>
            </table>
